...
namespace Watermelon.LevelSystem
{
    public class EditorSceneController : MonoBehaviour
    {
        ...
        {
            if (container == null) { var go = GameObject.Find("Container"); container = go != null ? go : new GameObject("Container"); }
            if (roomCustomObjectsContainer == null) { var go = GameObject.Find("RoomCustomObjectsContainer"); roomCustomObjectsContainer = go != null ? go : new GameObject("RoomCustomObjectsContainer"); }
            if (worldCustomObjectsContainer == null) { var go = GameObject.Find("WorldCustomObjectsContainer"); worldCustomObjectsContainer = go != null ? go : new GameObject("WorldCustomObjectsContainer"); }
        }
        ...
        public bool IsRoomChanged()
        {
            ...
            if(container == null || roomCustomObjectsContainer == null || worldCustomObjectsContainer == null)
            {
                return false;
            }

            if (roomItems == null || roomChests == null || roomEnemies == null || roomCustomObjects == null || worldCustomObjects == null)
            {
                RegisterRoomState();
                return false;
            }
