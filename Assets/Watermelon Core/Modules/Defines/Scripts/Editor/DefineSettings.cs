...
namespace Watermelon
{
    public static class DefineSettings
    {
        ...
        public static readonly RegisteredDefine[] STATIC_REGISTERED_DEFINES = new RegisteredDefine[]
        {
            ...
            // Custom SDKs
            new RegisteredDefine("USE_FIREBASE", "Firebase.FirebaseApp"),
            new RegisteredDefine("USE_APPSFLYER", "AppsFlyerSDK.AppsFlyer"),
            new RegisteredDefine("USE_ADMOB", "GoogleMobileAds.Api.MobileAds"),
