...
namespace LitMotion.Animation
{
    ...
    public sealed class LitMotionAnimation : MonoBehaviour
    {
        ...
        public void RecordAllStates()
        {
            foreach (var component in components)
            {
                if (component != null) component.RecordState();
            }
        }
        ...
        public void RestoreAllStates()
        {
            foreach (var component in components)
            {
                if (component != null) component.RestoreState();
            }
        }
        ...
        public void ClearCache()
        {
            foreach (var component in components)
            {
                if (component != null) component.ClearCache();
            }
        }
        ...
        public void Initialize()
        {
            foreach (var component in components)
            {
                if (component != null) component.OnInitialize();
            }
        }
